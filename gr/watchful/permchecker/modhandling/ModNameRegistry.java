...
/**
 * Stores and gives access to mappings for modid to shortname as well as
 * shortname to associated modinfo object
 * 
 * @author Watchful
 */
public class ModNameRegistry {
    ...
    public void loadMappings(ArrayList<ArrayList<String>> infos, ArrayList<ArrayList<String>> mappings, String baseUrl,
            String extension) {
