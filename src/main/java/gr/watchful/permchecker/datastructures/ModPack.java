...
public class ModPack {
    ...
    public void init () {
        ...
        if (metaVersions == null) {
            metaVersions = new ArrayList<>();
        }
        if (metaVersions.size() == 0) {
            metaVersions.add(new ModPackVersion("1.0.0"));
        }
        ...
        if (unknownModIDs == null) {
            unknownModIDs = new ArrayList<>();
        }
        if (shortNameMappings == null) {
            shortNameMappings = new HashMap<>();
        }
        if (modInfoMappings == null) {
    ...
    public Boolean saveThisObject () {
        if (Globals.getInstance().preferences.saveFolder == null) {
            return false;
        } else if (name != null && name.equals("Unnamed")) {
            return false;
        } else if (shortName == null || shortName.equals("")) {
            if (createShortName(this)) {
                Globals.getInstance().changeFlag = true;
            } else {
                return false;
            }
        }
    ...
    public static ModPack loadObject (File saveFile) {
        ...
        if (!FileUtils.getFileExtension(saveFile).equals("json")) {
            return null;
        }
        ModPack temp;
        try {
    ...
    public boolean equals (Object object) {
        if (!object.getClass().equals(ModPack.class)) {
            return false;
        }
    ...
    public String getIconName () {
        if (iconName == null || iconName.equals("")) {
            iconName = shortName + "Icon" + ".png";
        }
        return iconName;
    }

    public String getSplashName () {
        if (splashName == null || splashName.equals("")) {
            splashName = shortName + "Splash" + ".png";
        }
        return splashName;
    }

    public String getSquareName () {
        if (squareName == null || squareName.equals("")) {
            squareName = shortName + "Panel" + ".png";
        }
        return squareName;
    }
